...
const ContactPage = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <motion.div
        className="bg-white rounded-3xl shadow-xl p-10 flex flex-col md:flex-row gap-10 items-center justify-center"
        ...
        <div className="flex-1 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p>45 Greenfield Road<br />Nashik, Maharashtra, 422002</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="bg-primary-100 p-3 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            </div>
            <div>
              <h3 className="font-semibold text-lg">Email</h3>
              <p>contact@agriguide.com<br />support@agriguide.com</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="bg-primary-100 p-3 rounded-full">
          ...
          <div className="flex items-center gap-4 mt-6">
            <span className="font-semibold text-lg mr-2">Follow Us:</span>
            ...
            <a href="#" className="hover:text-primary-600 transition-colors" aria-label="Twitter">
